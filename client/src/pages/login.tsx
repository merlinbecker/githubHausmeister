      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-3 mb-6">
            ...
            <h1 className="text-3xl font-bold text-github-text">GitHub Hausmeister</h1>
          </div>
        ...
        <div className="bg-github-surface border border-github-border rounded-lg p-6 mb-6">
          <h2 className="text-xl font-semibold text-github-text mb-4">Features</h2>
          <div className="space-y-3">
            <div className="flex items-center space-x-3">
              <Zap className="text-github-blue" size={20} />
              <span className="text-github-text">Automated chore issue creation</span>
            </div>
            <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-github-text">Auto-merge with CI validation</span>
            </div>
          </div>
        </div>

        <div className="bg-github-surface border border-github-border rounded-lg p-6">
          <h2 className="text-lg font-semibold text-github-text mb-4">Get Started</h2>
          <p className="text-github-muted mb-6">
            Sign in with your GitHub account to start automating repository maintenance tasks.
          </p>
          ...
          <p className="text-xs text-github-muted mt-4 text-center">
            We'll only access repositories you explicitly authorize for maintenance.
          </p>
        </div>

        <div className="mt-6 text-center">
          <p className="text-sm text-github-muted">
            Need help? <a href="#" className="text-github-blue hover:underline">View Documentation</a>
          </p>
        </div>
      </div>
    </div>
