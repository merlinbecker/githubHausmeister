          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-start gap-3 flex-1">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div
                  className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium border ${workflowStatus.bgColor} ${workflowStatus.color}`}
                >
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <div className="text-sm text-blue-800">
                <p className="flex items-center gap-1 mb-2 font-medium">
                  ...
                  {issue.openPRs.length === 1
                    ? 'Open Pull Request:'
                    : `${issue.openPRs.length} Open Pull Requests:`}
                </p>
                {issue.openPRs.map((pr) => (
                  <div
                    key={pr.id}
                    className="ml-4 flex items-center gap-2 py-1"
                  >
