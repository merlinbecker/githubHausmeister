  ...
  const pauseMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        title: 'System Paused',
        description:
          'The system has been paused. No new tasks will be processed.',
      });
      onRefresh();
    },
    onError: (error: any) => {
  ...
  const resumeMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description:
          'The system has been resumed. Task processing will continue.',
      });
      onRefresh();
    },
    onError: (error: any) => {
    ...
    <section className="bg-github-surface border border-github-border rounded-lg p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            {systemRunning ? (
              <>
                <Pause
                  className="text-2xl text-github-amber group-hover:text-github-blue transition-colors"
                  size={32}
                />
                <span className="font-medium text-github-text">
                  Pause System
                </span>
                <span className="text-xs text-github-muted text-center">
              ...
              <>
                <Play
                  className="text-2xl text-github-green group-hover:text-github-blue transition-colors"
                  size={32}
                />
                <span className="font-medium text-github-text">
                  Resume System
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            <Trash2
              className="text-2xl text-github-red group-hover:text-github-blue transition-colors"
              size={32}
            />
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            <Download
              className="text-2xl text-github-muted group-hover:text-github-blue transition-colors"
              size={32}
            />
      ...
      <div className="mt-6 p-4 bg-github-bg rounded-lg border border-github-border">
        <h3 className="text-sm font-medium text-github-text mb-2">
          Quick Stats
        </h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div>
            <div
              className="text-lg font-bold text-github-text"
          ...
          <div>
            <div
              className="text-lg font-bold text-github-green"
              data-testid="text-successful-tasks"
            >
          ...
          <div>
            <div
              className="text-lg font-bold text-github-red"
              data-testid="text-failed-tasks"
            >
              {stats?.failedTasks || 0}
            </div>
